...
public class ChatService implements IChatService {
    ...
    public Boolean cambiarAliasDelChat(Chat chat, String nuevoNombre) throws Exception {
        ...
        System.out.println("Alias del chat cambiado a: " + nuevoNombre);
        return true;
    }
    ...
    public List<Chat> cargarChatsDelUsuario(Usuario usuario) throws Exception {
        ...
        System.out.println("Cargando chats del usuario: " + usuario.getNombre());
        return new ArrayList<>(); // devolver lista vacía por ahora
    }
    ...
    public Boolean mandarMensaje(Chat chat, String mensaje) throws Exception {
        ...
        // Lógica básica simulada
        System.out.println("Mensaje enviado al chat: " + mensaje);
        return true;
    }
